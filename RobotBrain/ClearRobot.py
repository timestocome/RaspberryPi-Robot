...
class world():
    ...
    def __init__(self):
        ...
        self.actions = move_robot.actions()
    ...
    def move(self, action):
        ...
        if action == 0:         
            self.moveRobot.center_forward()
            reward += 1
        elif action == 1:       
            self.moveRobot.hard_right_forward()
            reward += 1
        elif action == 2:       
            self.moveRobot.right_forward()
            reward += 1
        elif action == 3:      
            self.moveRobot.left_forward()
            reward += 1
        elif action == 4:       
            self.moveRobot.hard_left_forward()
            reward += 1
        elif action == 5:       
            self.moveRobot.center_reverse()
            reward += 1
        elif action == 6:
            self.moveRobothard_right_reverse()
            reward += 1
        elif action == 7:      
            self.moveRobotright_reverse()
            reward += 1
        elif action == 8:       
            self.moveRobot.left_reverse()
            reward += 1
        elif action == 9:       
            self.moveRobothard_left_reverse()
            reward += 1
